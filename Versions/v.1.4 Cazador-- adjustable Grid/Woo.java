...
public class Woo{ 
	...
	System.out.println("Okay, " + name + " there're " + numPrey + " prey for you to catch. Go!");
	...
	if (((xcor <= g.getSideLength()) && (xcor > 0)) && ((ycor <= g.getSideLength()) && (ycor > 0))){//=============== g.getSideLength()
	...
	int sideLength;
	System.out.println("How big do you want your hunt to be? Choose a side length for your map, from 9 to 20.");
	sideLength = Keyboard.readInt();
	if(sideLength > 20 || sideLength < 9){
	    System.out.println("Bad number: 9 chosen as default.");
	    sideLength = 9;
	}
