...
public class Grid {
    ...
    public String toString(){//new one for grids with side of n (we should) 
	String retStr =  "      ";
	for(int x = 1; x <= sideLength; x++){//sets string that is the axis that appears at the top of the grid
	    if( x == sideLength){
	...
	String horizontal = "   -";
	for(int x = 0; x < sideLength; x++){//sets the string that is the horizontal partitions running through the grid
	    if( x == sideLength - 1){
		horizontal += "------\n";
	    }
	    else{
